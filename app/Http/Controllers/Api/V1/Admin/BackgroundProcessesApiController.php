...
class BackgroundProcessesApiController extends Controller
{
    ...
    public function store(StoreBackgroundProcessRequest $request)
    {
        ...
        if ($request->input('file', false)) {
            $backgroundProcess->addMedia(storage_path('tmp/uploads/' . $request->input('file')))->toMediaCollection('file');
        }

        if ($request->input('images', false)) {
            $backgroundProcess->addMedia(storage_path('tmp/uploads/' . $request->input('images')))->toMediaCollection('images');
        }
