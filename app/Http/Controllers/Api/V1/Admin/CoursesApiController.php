...
class CoursesApiController extends Controller
{
    public function index()
    {
        ...
        return new CourseResource(Course::with(['associated_processes', 'roles', 'focalizacion_territorials', 'operators', 'references', 'courseshooks'])->get());
    }
    ...
    public function show(Course $course)
    {
        ...
        return new CourseResource($course->load(['associated_processes', 'roles', 'focalizacion_territorials', 'operators', 'references', 'courseshooks']));
    }
