...
class CoursesUsersApiController extends Controller
{
    public function index()
    {
        ...
        return new CoursesUserResource(CoursesUser::with(['user', 'start_date', 'badges', 'created_by'])->get());
    }
    ...
    public function show(CoursesUser $coursesUser)
    {
        ...
        return new CoursesUserResource($coursesUser->load(['user', 'start_date', 'badges', 'created_by']));
    }
