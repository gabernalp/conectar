...
class SelfInterestedUsersApiController extends Controller
{
    public function index()
    {
        ...
        return new SelfInterestedUserResource(SelfInterestedUser::with(['user', 'coursehook'])->get());
    }
    ...
    public function show(SelfInterestedUser $selfInterestedUser)
    {
        ...
        return new SelfInterestedUserResource($selfInterestedUser->load(['user', 'coursehook']));
    }
