...
class ChallengesUsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.challengesUsers.index', compact('challengesUsers', 'challenges', 'users', 'reference_types'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.challengesUsers.create', compact('challenges', 'users'));
    }
    ...
    public function edit(ChallengesUser $challengesUser)
    {
        ...
        return view('admin.challengesUsers.edit', compact('challenges', 'users', 'challengesUser'));
    }
