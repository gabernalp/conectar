...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('min_age', function ($row) {
                return $row->min_age ? $row->min_age : "";
            });
            $table->editColumn('max_age', function ($row) {
                return $row->max_age ? $row->max_age : "";
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'documenttype', 'department', 'city', 'devices', 'roles', 'newsletter_subscription', 'approved', 'verified', 'operator']);
