...
class MeetingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.meetings.index', compact('meetings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.meetings.create', compact('users', 'departments', 'tags'));
    }
    ...
    public function store(StoreMeetingRequest $request)
    {
        ...
        if ($request->input('file', false)) {
            $meeting->addMedia(storage_path('tmp/uploads/' . $request->input('file')))->toMediaCollection('file');
        }
        ...
        return redirect()->route('frontend.meetings.index');
    }
    ...
    public function edit(Meeting $meeting)
    {
        ...
        return view('frontend.meetings.edit', compact('users', 'departments', 'tags', 'meeting'));
    }
    ...
    public function show(Meeting $meeting)
    {
        ...
        return view('frontend.meetings.show', compact('meeting'));
    }
