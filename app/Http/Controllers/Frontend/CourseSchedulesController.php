...
class CourseSchedulesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.courseSchedules.index', compact('courseSchedules'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.courseSchedules.create', compact('courses', 'tutors'));
    }
    ...
    public function store(StoreCourseScheduleRequest $request)
    {
        ...
        return redirect()->route('frontend.course-schedules.index');
    }
    ...
    public function edit(CourseSchedule $courseSchedule)
    {
        ...
        return view('frontend.courseSchedules.edit', compact('courses', 'tutors', 'courseSchedule'));
    }
    ...
    public function show(CourseSchedule $courseSchedule)
    {
        ...
        return view('frontend.courseSchedules.show', compact('courseSchedule'));
    }
