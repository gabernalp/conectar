...
class EventsSchedulesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.eventsSchedules.index', compact('eventsSchedules'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.eventsSchedules.create');
    }
    ...
    public function store(StoreEventsScheduleRequest $request)
    {
        ...
        if ($request->input('image', false)) {
            $eventsSchedule->addMedia(storage_path('tmp/uploads/' . $request->input('image')))->toMediaCollection('image');
        }

        if ($request->input('podcast', false)) {
            $eventsSchedule->addMedia(storage_path('tmp/uploads/' . $request->input('podcast')))->toMediaCollection('podcast');
        }
        ...
        return redirect()->route('frontend.events-schedules.index');
    }
    ...
    public function edit(EventsSchedule $eventsSchedule)
    {
        ...
        return view('frontend.eventsSchedules.edit', compact('eventsSchedule'));
    }
    ...
    public function show(EventsSchedule $eventsSchedule)
    {
        ...
        return view('frontend.eventsSchedules.show', compact('eventsSchedule'));
    }
