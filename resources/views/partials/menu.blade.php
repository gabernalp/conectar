<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('programacion_de_ciclo_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/course-schedules*") ? "c-show" : "" }} {{ request()->is("admin/courses-users*") ? "c-show" : "" }} {{ request()->is("admin/challenges-users*") ? "c-show" : "" }} {{ request()->is("admin/feedbacks-users*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
