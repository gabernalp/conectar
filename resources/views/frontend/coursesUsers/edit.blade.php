    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.courses-users.update", [$coursesUser->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="course_name" id="course_name" value="{{ old('course_name', $coursesUser->course_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="challenges" id="challenges" value="{{ old('challenges', $coursesUser->challenges) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="badges[]" id="badges" multiple>
