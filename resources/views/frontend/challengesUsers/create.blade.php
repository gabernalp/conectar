        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.challengesUser.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.challenges-users.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="challenge_id" id="challenge_id">
                                @foreach($challenges as $id => $challenge)
                                    <option value="{{ $id }}" {{ old('challenge_id') == $id ? 'selected' : '' }}>{{ $challenge }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="reference_text" id="reference_text">{{ old('reference_text') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reference_media" id="reference_media" value="{{ old('reference_media', '') }}">
