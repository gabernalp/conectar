    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.points-rules.update", [$pointsRule->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="points_item">{{ trans('cruds.pointsRule.fields.points_item') }}</label>
                            <input class="form-control" type="text" name="points_item" id="points_item" value="{{ old('points_item', $pointsRule->points_item) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="points" id="points" value="{{ old('points', $pointsRule->points) }}" step="1">
