                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.courses.update", [$course->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="goal" id="goal" required>{{ old('goal', $course->goal) }}</textarea>
                            @if($errors->has('goal'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('goal') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="support_required" id="support_required" value="1" {{ $course->support_required || old('support_required', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hours" id="hours" value="{{ old('hours', $course->hours) }}">
                            @if($errors->has('hours'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('hours') }}
                                </div>
