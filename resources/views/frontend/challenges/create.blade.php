    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.challenges.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="goal" id="goal">{{ old('goal') }}</textarea>
                            @if($errors->has('goal'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('goal') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="capsule" id="capsule" value="{{ old('capsule', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="capsule_content" id="capsule_content">{{ old('capsule_content') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="action_detail" id="action_detail">{{ old('action_detail') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="hours_adding" id="hours_adding" value="{{ old('hours_adding', '') }}" step="1" required>
