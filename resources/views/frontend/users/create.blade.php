                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="document" id="document" value="{{ old('document', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="etnia" id="etnia">
                                ...
                                @foreach(App\User::ETNIA_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('etnia', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('etnia'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="academic_background" id="academic_background">
                                ...
                                @foreach(App\User::ACADEMIC_BACKGROUND_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('academic_background', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="min_age" id="min_age" value="{{ old('min_age', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="devices[]" id="devices" multiple>
                                @foreach($devices as $id => $devices)
                                    <option value="{{ $id }}" {{ in_array($id, old('devices', [])) ? 'selected' : '' }}>{{ $devices }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="newsletter_subscription" id="newsletter_subscription" value="1" {{ old('newsletter_subscription', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="entity" id="entity" value="{{ old('entity', '') }}">
