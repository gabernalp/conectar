                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="documenttype_id" id="documenttype_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="document" id="document" value="{{ old('document', $user->document) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', $user->phone_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="zona" id="zona">
                                ...
                                @foreach(App\User::ZONA_SELECT as $key => $label)
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="etnia" id="etnia">
                                ...
                                @foreach(App\User::ETNIA_SELECT as $key => $label)
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="academic_background" id="academic_background">
                                <option value disabled {{ old('academic_background', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                                @foreach(App\User::ACADEMIC_BACKGROUND_SELECT as $key => $label)
                        ...
                        <div class="form-group">
                            <label for="min_age">{{ trans('cruds.user.fields.min_age') }}</label>
                            <input class="form-control" type="number" name="min_age" id="min_age" value="{{ old('min_age', $user->min_age) }}" step="1">
                            @if($errors->has('min_age'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('min_age') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.user.fields.min_age_helper') }}</span>
                        </div>
                        <div class="form-group">
                            <label for="max_age">{{ trans('cruds.user.fields.max_age') }}</label>
                            <input class="form-control" type="number" name="max_age" id="max_age" value="{{ old('max_age', $user->max_age) }}" step="1">
                            @if($errors->has('max_age'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('max_age') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.user.fields.max_age_helper') }}</span>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="devices[]" id="devices" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="modality" id="modality">
                                ...
                                @foreach(App\User::MODALITY_SELECT as $key => $label)
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="newsletter_subscription" id="newsletter_subscription" value="1" {{ $user->newsletter_subscription || old('newsletter_subscription', 0) === 1 ? 'checked' : '' }}>
                                <label for="newsletter_subscription">{{ trans('cruds.user.fields.newsletter_subscription') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="entity" id="entity" value="{{ old('entity', $user->entity) }}">
