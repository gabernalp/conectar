    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.events-schedules.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="invitados" id="invitados" value="{{ old('invitados', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="newsletter" id="newsletter">{!! old('newsletter') !!}</textarea>
