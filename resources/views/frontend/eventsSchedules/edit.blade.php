    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.events-schedules.update", [$eventsSchedule->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="description">{{ trans('cruds.eventsSchedule.fields.description') }}</label>
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $eventsSchedule->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="date" id="date" value="{{ old('date', $eventsSchedule->date) }}">
                            @if($errors->has('date'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('date') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="link" id="link" value="{{ old('link', $eventsSchedule->link) }}">
                            @if($errors->has('link'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('link') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="podcast-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="invitados" id="invitados" value="{{ old('invitados', $eventsSchedule->invitados) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="newsletter" id="newsletter">{!! old('newsletter', $eventsSchedule->newsletter) !!}</textarea>
...
<script>
    ...
    url: '{{ route('frontend.events-schedules.storeMedia') }}',
    maxFilesize: 5, // MB
