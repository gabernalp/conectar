    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.self-interested-users.update", [$selfInterestedUser->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="contact" id="contact" value="1" {{ $selfInterestedUser->contact || old('contact', 0) === 1 ? 'checked' : '' }}>
