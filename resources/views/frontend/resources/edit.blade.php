                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.resources.update", [$resource->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $resource->name) }}">
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comments" id="comments">{{ old('comments', $resource->comments) }}</textarea>
