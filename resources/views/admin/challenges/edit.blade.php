    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.challenges.update", [$challenge->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $challenge->description) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('goal') ? 'is-invalid' : '' }}" name="goal" id="goal">{{ old('goal', $challenge->goal) }}</textarea>
                @if($errors->has('goal'))
                    <div class="invalid-feedback">
                        {{ $errors->first('goal') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('capsule') ? 'is-invalid' : '' }}" type="text" name="capsule" id="capsule" value="{{ old('capsule', $challenge->capsule) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hours_adding') ? 'is-invalid' : '' }}" type="number" name="hours_adding" id="hours_adding" value="{{ old('hours_adding', $challenge->hours_adding) }}" step="1" required>
