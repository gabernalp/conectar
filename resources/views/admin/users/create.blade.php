    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_age') ? 'is-invalid' : '' }}" type="number" name="min_age" id="min_age" value="{{ old('min_age', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('newsletter_subscription') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="newsletter_subscription" id="newsletter_subscription" value="1" {{ old('newsletter_subscription', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('entity') ? 'is-invalid' : '' }}" type="text" name="entity" id="entity" value="{{ old('entity', '') }}">
