    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_age') ? 'is-invalid' : '' }}" type="number" name="min_age" id="min_age" value="{{ old('min_age', $user->min_age) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_age') ? 'is-invalid' : '' }}" type="number" name="max_age" id="max_age" value="{{ old('max_age', $user->max_age) }}" step="1">
