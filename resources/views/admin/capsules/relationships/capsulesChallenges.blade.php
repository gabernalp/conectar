...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-capsulesChallenges">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.challenge.fields.capsules') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($challenges as $key => $challenge)
                        <tr data-entry-id="{{ $challenge->id }}">
                            ...
                            <td>
                                @foreach($challenge->capsules as $key => $item)
                                    <span class="badge badge-info">{{ $item->name }}</span>
                                @endforeach
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-capsulesChallenges:not(.ajaxTable)').DataTable({ buttons: dtButtons })
