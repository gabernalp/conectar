                        ...
                        <tr data-entry-id="{{ $eventsSchedule->id }}">
                            ...
                            <td>
                                @can('events_schedule_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.events-schedules.show', $eventsSchedule->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('events_schedule_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.events-schedules.edit', $eventsSchedule->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('events_schedule_delete')
                                    <form action="{{ route('admin.events-schedules.destroy', $eventsSchedule->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
