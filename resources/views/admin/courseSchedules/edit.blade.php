    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.course-schedules.update", [$courseSchedule->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iterations_number') ? 'is-invalid' : '' }}" type="text" name="iterations_number" id="iterations_number" value="{{ old('iterations_number', $courseSchedule->iterations_number) }}">
